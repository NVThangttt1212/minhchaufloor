...
import { DetailConstructionComponent } from './components/construction/detail-construction/detail-construction.component';
...
const routes: Routes = [
  ...
  { path: 'construction/:id', component: DetailConstructionComponent },
